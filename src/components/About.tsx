        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-lg text-gray-300">
              Desenvolvedor Salesforce Sênior, com experiência em projetos nacionais e globais nos setores bancário, seguros e energia.
            </p>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-square rounded-2xl overflow-hidden bg-gradient-to-r from-primary to-secondary p-1 shadow-glow-strong">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Projetos Internacionais</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Bancário, Seguros, Energia</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Ecossistema Salesforce</p>
                    </div>
                  </div>
                </div>
              </div>
